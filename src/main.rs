...
async fn main() {
    ...
    loop {
        ...
        draw_circle(cur.x, cur.y, min_dist2.min(min_dist+2.0*circles[closest].1)+3.0, BLUE);
        draw_circle(circles[closest].0.x, circles[closest].0.y, circles[closest].1+3.0, BLUE);
